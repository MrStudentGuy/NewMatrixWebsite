            ...
            <div className={"overflow-x-hidden mb-2 md:mb-28"}>
                <section className="bg-matrixPurple">
                    <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
                        <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-6xl">We&apos;re Team Matrix</h1>
                ...
                <section className={"mt-8 mx-4 md:mx-2"}>
                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12">
                            <h2 className="text-white text-3xl font-extrabold mb-2">Meet The Team</h2>
                            <p className="text-lg font-normal text-gray-400 mb-4">Team Matrix attracts the most passionate members in the community. We&apos;re a family of aspiring engineers, innovators, and problem-solvers, all united by our love for technology.</p>
                            <Link href="/meet-the-team" className="text-blue-400 hover:underline font-medium text-lg inline-flex items-center">See
                        ...
                        <div className="bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12">
                            <h2 className="text-white text-3xl font-extrabold mb-2">Contact Us</h2>
                            <p className="text-lg font-normal text-gray-400 mb-4">Want to conduct an outreach session with us, collaborate in anyway, or just chat?</p>
                            <Link href="/contact" className="text-blue-400 hover:underline font-medium text-lg inline-flex items-center">Get In Touch
                                <svg className="w-3.5 h-3.5 ml-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
                                </svg>
                            </Link>
