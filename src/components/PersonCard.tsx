...
const PersonCard = (props :props) => {
    return (
        <div className={"hover:scale-110 hover:cursor-pointer transition duration-150 delay-0 text-white bg-gray-800 rounded-xl h-72 w-52 flex flex-col py-5 px-2 shadow-2xl items-center"}>
